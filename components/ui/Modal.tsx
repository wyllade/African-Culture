      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={cn(
              'relative z-10 w-full max-w-lg rounded-2xl bg-white/90 dark:bg-stone-900/90 backdrop-blur-xl p-6 shadow-2xl border border-white/20 dark:border-stone-700/50',
              className
            )}
          >
